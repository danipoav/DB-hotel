...
import { ShowWrapper, ShowContainer, BookingImage, BookingDetails } from '../../styles/Generic/ShowComponent.styles';
    ...
    return (
        <ShowWrapper>
            ...
            <ShowContainer>
                {booking ? (
                    <>
                        <BookingImage src={booking.photo} alt={booking.name || "Imagen de la reserva"} />
                        <BookingDetails>
