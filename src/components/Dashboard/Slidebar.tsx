        ...
        <SlideContent>
            ...
            <OptionList>
                <Link to="/home" style={{ textDecoration: 'none', color: 'inherit' }}>
                    <OptionContainer current={location.pathname === '/home'} >
                        ...
                        <span className="hover-text">overview</span>
                    </OptionContainer>
                </Link>
                <Link to="/home/rooms" style={{ textDecoration: 'none', color: 'inherit' }}>
                    <OptionContainer current={location.pathname === '/home/rooms'} >
                        ...
                        <span className="hover-text">rooms</span>
                    </OptionContainer>
                </Link>
                <Link to="/home/bookings" style={{ textDecoration: 'none', color: 'inherit' }}>
                    <OptionContainer current={location.pathname === '/home/bookings'} >
                        ...
                        <span className="hover-text">Bookings</span>
                    </OptionContainer>
                </Link>
                <Link to="/home/users" style={{ textDecoration: 'none', color: 'inherit' }}>
                    <OptionContainer current={location.pathname === '/home/users'} >
                        ...
                        <span className="hover-text">users</span>
                    </OptionContainer>
                </Link>
                <Link to="/home/contacts" style={{ textDecoration: 'none', color: 'inherit' }}>
                    <OptionContainer current={location.pathname === '/home/contacts'} >
